    ...
    return (
      !this.state.loading
        ...
        <div className="" style={{overflow:'hidden'}}>
          < HashRouter >
            <Navbar account={this.state.account} connectToWeb3={this.connectToWeb3} />
            <Switch>
              <Route path="/" exact>
                <Main />
              </Route>
              ...
              <Route path="/mint-nft" exact>
                <MintNft account={this.state.account} connectToWeb3={this.connectToWeb3} />
              </Route>
        ...
        :
        <div className="text-center align-items-center justify-content-center" style={{height:'100vh',display:'flex'}}>
          <div class="spinner-border text-primary" role="status">
          </div>
          <h3 className="text-light m-2">
          Please Wait.....
          </h3>
