  ...
  return (
    <>
      <div className="contrainer text-light mb-5" style={{ height: "100vh" }}>
        <div className="bg-holder d-flex align-items-center justify-content-center">
          <div className="row m-1 align-items-center justify-content-center">
            <div className="col-12 text-center">
              <h1
                className="display-3 glitch"
                data-text="Mint Your Criminal Now!"
              >
                Mint Your Criminal Now!
              </h1>
              {account ? (
                <>
                  <button
                  ...
                  <p className="lead mt-2" style={{ wordBreak: "break-all" }}>
                    Address: {account}
                  </p>
                </>
              ) : (
                <>
                  <button
                    ...
                    className="btn btn-outline-primary btn-lg px-5 my-2"
                  >
                    Connect
                  </button>
              ...
              <div className="col-6 text-center">
                <div className="mt-4">
                  <input
                    ...
                    placeholder=""
                  />
                  <button className="btn-hover color-9 px-5 mt-2" type="button">
                    Mint
                  </button>
                </div>
              </div>
